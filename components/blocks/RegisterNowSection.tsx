      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="border border-gray-100 rounded-xl p-6 md:p-8 bg-white shadow-sm">
          ...
          Experience world-class education, innovative curriculum, and holistic development in a nurturing environment that prepares you for global success. */}
            <span className="font-bold">Join the Doon International School Community</span>
            <br />
            <span className="font-bold">Begin your journey toward excellence with a world-class education designed for global success. Our innovative curriculum, holistic development programs, and nurturing environment empower every student to grow, lead, and thrive.</span>
            <br />
            <span className="font-bold">Register today and take the first step toward your future.</span>
          </p>
