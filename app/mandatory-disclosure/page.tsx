      ...
      <section className="container mx-auto py-12 px-4 md:px-6">
        ...
        <div className="overflow-x-auto -mx-8 md:mx-0 px-4 md:px-0">
          <table className="w-full border border-gray-300 text-[11px] md:text-[15px] font-body text-gray-800 min-w-[350px] md:min-w-[600px]">
            ...
            <tbody>
              {[
                { text: "COPIES OF AFFILIATION/UPGRADATION LETTER AND RECENT EXTENSION OF AFFILIATION, IF ANY", pdf: "CBSEA.pdf" },
                { text: "COPIES OF SOCIETIES/TRUST/COMPANY REGISTRATION/RENEWAL CERTIFICATE, AS APPLICABLE", pdf: "SOCIETY REGISTRATION (2).pdf" },
                { text: "COPY OF NO OBJECTION CERTIFICATE (NOC) ISSUED, IF APPLICABLE BY THE STATE GOVT/UT", pdf: "NOC.pdf" },
                ...
                { text: "COPY OF VALID FIRE SAFETY CERTIFICATE ISSUED BY THE COMPETENT AUTHORITY", pdf: "Fire_Safety_Certificate.pdf" },
